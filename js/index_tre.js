...
window.onload = function() {
  boxCorrette.innerHTML = `<p class="testoCalcolo"> <span>Correct<br> <b>${parseInt((punteggioUtente/totaleDomande)*100)}% </span></b><br>${punteggioUtente}/${totaleDomande} questions </p>`;

  boxSbagliate.innerHTML = `<p class="testoCalcolo"> <span>Wrong <br> <b>${parseInt([(totaleDomande-punteggioUtente)/totaleDomande]*100)}%</span></b><br>${totaleDomande-punteggioUtente}/${totaleDomande} questions </p>`;
}
